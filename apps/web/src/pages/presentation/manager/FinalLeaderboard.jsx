...
export default function FinalLeaderboard({ leaderboardData, onExit }) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-900 flex flex-col items-center justify-center overflow-hidden">
      ...
      <div
        className="absolute top-6 right-6 flex items-center gap-2 rounded-full bg-white/10 px-3 py-1 text-[11px] sm:text-xs font-medium text-white/85"
        role="status"
        aria-live="polite"
          ...
          >
            ...
            <div className="text-center mb-2">
              ...
              <p className={`font-mono font-bold ${style.text}`}>
                {Math.round(player.total_points)} {"امتیاز"}
              </p>
            </div>
